...
> 2026-09-19 11:45 UTC
> Elapsed: 2056.8s

## Scan

- Pages visited: 1749
- Pages with >=1 PDF: 1583
- Circular index pages: 9
- Circular detail pages: 306
- Pages that failed to load: 0
- Excluded as not In-Force: 64
- PDFs in manifest: 381

## Fetch

- Downloaded: 380 | already present: 0 | failed: 1

## Failed downloads

Retried 3x. Re-run the crawl stage to try again.

- `SAMA_EN_2985_VER1.pdf` — no %PDF header — error page or wrong content
...
- `SAMA_RD%20637_en.pdf`
- `SAMA_RD%20M142_en.pdf`
