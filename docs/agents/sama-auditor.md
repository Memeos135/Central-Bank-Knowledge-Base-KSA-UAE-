---
name: sama-auditor
description: Review a sama-counsel draft for evidence support, applicability, reasoning, completeness and citation accuracy. Support standalone and GCC handoff modes; return actionable exceptions without repeating research or drafting a competing answer.
---
...
- A title or broad category used as a substitute for the relevant application clause.
